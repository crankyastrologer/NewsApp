<script>
    ...
    import { HomeSolid, StarSolid, AdjustmentsVerticalOutline, UserCircleSolid, BookmarkSolid } from 'flowbite-svelte-icons';
  </script>
  


<BottomNav position="sticky" navType="application" classInner="grid-cols-5">
  ...
  <BottomNavItem btnName="favourite" appBtnPosition="middle">
    ...
    <Tooltip arrow={false}>favourite</Tooltip>
  </BottomNavItem>
  <div class="flex items-center justify-center">
    <BottomNavItem btnName="Create new item" appBtnPosition="middle" btnClass="inline-flex items-center justify-center w-10 h-10 font-medium bg-primary-600 rounded-full hover:bg-primary-700 group focus:ring-4 focus:ring-primary-300 focus:outline-none dark:focus:ring-primary-800">
      <BookmarkSolid class="text-white" />
